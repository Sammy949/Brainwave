    ...
    <Section crosses>
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          ...
          <ul className="max-w-[22rem] mb-4 md:mb-14">
          ...
          <div className="mt-4 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative -top-[1.6rem] flex items-center justify-center w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/15 rounded-2xl -rotate-${
                      index * 45
                    }`}
                  >
                    <img
